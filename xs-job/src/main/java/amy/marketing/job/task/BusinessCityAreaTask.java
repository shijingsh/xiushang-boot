 ...
 *
 */
@Component("businessCityAreaTask")
public class BusinessCityAreaTask {
	...
	public void run(String params){
		...
		String result=HttpUtil.post(AgentConfig.getUrl("/api-zcloud/zcloud/api/dictionary/cityBusinessArea"),param);
		System.out.println(result);

		businessAreaService.saveAllCityArea(result);
	}
}
