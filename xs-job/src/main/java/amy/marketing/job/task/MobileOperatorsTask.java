 ...
 *
 */
@Component("mobileOperatorsTask")
public class MobileOperatorsTask {
	...
	public void run(String params){
		...
		String result=HttpUtil.post(AgentConfig.getUrl("/api-zcloud/zcloud/api/dictionary/mobileOperators"),param);
