...
import amy.marketing.common.exception.BusinessException;
import amy.marketing.common.utils.Constant;
import amy.marketing.dao.entity.SysJobEntity;
import amy.marketing.dao.mapper.SysJobMapper;
import amy.marketing.job.utils.ScheduleUtils;
import amy.marketing.service.SysJobService;
 ...
 */
@Service
public class JobServiceImpl extends ServiceImpl<SysJobMapper, SysJobEntity> implements SysJobService {
    @Resource
