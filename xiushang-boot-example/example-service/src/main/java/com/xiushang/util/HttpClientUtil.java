...
public class HttpClientUtil
{
  ...
  public static String sendGetRequest(String reqURL)
  {
    ...
    try {
      ...
      log.info(new StringBuilder().append("HTTP应答完整报文=[").append(respStatusLine).append("\r\n").append(respHeaderMsg).append("\r\n\r\n").append(respBodyMsg).append("]").toString());
      log.info("-------------------------------------------------------------------------------------------");
    }
  ...
  public static void main(String[] args) {
    ...
    try {
      log.info(sendPostSSLRequest("https://sandbox.99bill.com/msgateway/recvMerchantRefundAction.htm", params, "UTF-8"));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
